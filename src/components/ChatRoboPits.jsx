          ...
          steps={[
            ...
            },
            {
              ...
              options: [
                {
                  value: 'f',
                  label: 'Dónde puedo pasar a recoger mi pedido?',
                  trigger: '7A',
                },
                ...
                {
                  value: 'y',
                  label: '¿Venden piezas por mayoreo?',
                  trigger: '7D',
                },
                {
                  value: 'x',
                  label: 'Cuál es su horario de servicio?',
                  trigger: '7X',
                },
              ],
            },
            {
              id: '7A',
              message:
                'Hacemos entregas en el centro de Huejutla y Parque de Poblamiento.',
              trigger: '9',
            },
            {
              id: '7B',
            ...
            },
            {
              id: '7X',
              message:
                'Todos los días de 9am-1pm y de 2pm-7pm, Domingo sin servicio :)',
              trigger: '9',
            },
            {
              id: '9',
