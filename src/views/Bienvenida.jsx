      ...
      <div className="container-bienvenida">
        <div className="grid text-center">
          <h1 className="text-4xl text-blue-400 font-bold">
            ¡Hola, te damos la bienvenida jesus ivan bautista hernandez!
          </h1>
        ...
        <div className="place-content-center my-7">
          <div className="h-56 sm:h-64 xl:h-80 2xl:h-96">
            <Carousel slideInterval={2000}>
              <img
                src="images/productos/componentes/arduino.webp"
                alt="Arduino"
              />
              <img
                src="images/productos/herramientas/soldar.webp"
                alt="Soldar"
              />
        ...
        <h1 className="text-xl text-teal-500 font-sans font-bold text-center mt-5 mb-10">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="flex justify-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 mb-4">
            ...
            >
              <Meta
                title="Componentes"
                description="Arduino, NodeMCU y más..."
              />
            </Card>
          </div>
          <div className="flex justify-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 mb-4">
            ...
            >
              <Meta
                title="Herramientas"
                description="Cautín, Estaño, pinzas y más..."
              />
            </Card>
          </div>
          <div className="flex justify-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 mb-4">
            <Card
              ...
              hoverable
              cover={
                <img alt="Cables" src="images/productos/cables/cables.webp" />
              }
            >
