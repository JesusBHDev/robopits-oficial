              ...
              <div className="">
                <div className="flex flex-col md:flex-row md:items-center w-auto mx-auto">
                  ...
                  <div className="md:w-1/2 w-auto mx-auto p-5">
                      ...
                      <div className="flex items-center">
                        <NavLink to="">
                          <Icon
                            ...
                            className="text-black hover:text-blue-500 transition-all duration-300 ease-in-out"
                          />
                        </NavLink>
                      </div>
                    </div>
                    ...
                    <p
                      className={`text-base w-auto mt-4 text-gray-500 ${expanded ? '' : 'line-clamp-3'}`}
                    >
                    ...
                    <div className="flex mt-4">
                      <CustomDropdown
                        options={options}
                        onSelect={(key) => setCantidad(Number(key))}
                      />
                    ...
                    <div className="flex space-x-2 mt-4 md:w-full w-auto">
                      ...
                      <button
                        type="submit"
                        className="bg-[#3BA4F6] text-white rounded p-2 font-bold md:w-44 w-auto hover:bg-[#2587eb]"
                      >
                        Comprar ahora
                      </button>
                      <button
                        ...
                        className="bg-[#4db4b2] text-white rounded p-2 font-bold md:w-44 w-auto hover:bg-[#329696]"
                      >
                        Agregar al carrito
                      </button>
                    </div>
                    ...
                    <div className="mt-4 md:w-full w-20 mx-auto">
                      <ToggleDiv
                        ...
                        content={producto.Caracteristicas}
                      />
                      <ToggleDiv
                        title="Categoría"
