...
const Registro = () => {
  ...
  const onSubmit = handleSubmit(async (values) => {
    try {
      ...
      alert(
        'Ocurrió un error al enviar el formulario. Por favor, intenta nuevamente más tarde.'
      );
    }
  });
    ...
    try {
      ...
      if (result.status === 'ok' && result.email_status === 'VALID') {
        ...
        if (result.email_status === 'You have reached your limit.') {
          ...
          return {
            isValid: false,
            message: result.message || 'El correo no existe.',
          };
        }
      }
      ...
      <div className="img-fondo-registro h-screen w-screen">
        ...
        <div className="container-registro">
          ...
          <img
            ...
            src="images/robopits-transparente2.webp"
            alt="RoboPits"
          />
          <div className="form-registro">
            <form onSubmit={onSubmit}>
              ...
              <div className="contenedor-cajas-registro">
                ...
                <label className="nom-cajas-registro" htmlFor="Nombre">
                  Nombre de usuario
                </label>
                <input
                  className="cajas-registro"
                  id="Nombre"
                  type="user"
                ...
                {errors.Nombre?.type === 'required' && (
                  <div className="contenedor-msj-error-registro">
                    <p className="mensajes-error-registro">
                ...
                {errors.Nombre?.type === 'maxLength' && (
                  <p className="mensajes-error-registro">
                    El campo de nombre no puede contener más de 10 caracteres
                  </p>
                )}
                ...
                {errors.Nombre?.type === 'pattern' && (
                  <p className="mensajes-error-registro">
                    Ingresa un nombre de usuario valido. Solo puedes usar
                    letras, números y guión bajo o alto
                  </p>
                )}
              </div>
              ...
              <div className="contenedor-cajas-registro">
                {/* Input del Email */}
                <label className="nom-cajas-registro" htmlFor="Email">
                  Email
                </label>
                <input
                  className="cajas-registro"
                ...
                {errors.Email?.type === 'pattern' && (
                  <p className="mensajes-error-registro">
                    Ingresa un correo válido, no olvides usar @ y .com
                  </p>
                )}

                <div className="contenedor-cajas-registro">
                  {/* Input de la contraseña */}
                  <label className="nom-cajas-registro" htmlFor="Password">
                    Contraseña
                  </label>
                  ...
                  {errors.Password?.type === 'pattern' && (
                    <p className="mensajes-error-registro">
                      Ingresa una contraseña válida con mínimo 8 cáracteres.
                      Debes usar como mínimo 1 letra mayúscula, 1 letra
                      minúscula, 1 símbolo raro y 1 número
                    </p>
                  )}
              ...
              <div className="contenedor-cajas-registro">
                <div className="password-toggle2">
                  <label className="nom-cajas-registro" htmlFor="Password2">
                  ...
                  <div className="input-contrasena-ojo">
                    ...
                    <button
                      ...
                      onClick={() =>
                        togglePassword2Visibility(!password2Visible)
                      }
                    >
                      {password2Visible ? (
                        <Icon icon="mdi:eye" />
                ...
                {errors.Password2?.type === 'pattern' && (
                  <p className="mensajes-error-registro">
                    Ingresa una contraseña válida con mínimo 8 cáracteres. Debes
                    usar como mínimo 1 letra mayúscula, 1 letra minúscula, 1
                    símbolo raro y 1 número
                  </p>
                )}
              ...
              <div className="botones-registro">
                ...
                <input
                  type="submit"
                  className="btn-registrar-registro"
                  value={loading ? 'Cargando...' : 'Registrarse'}
                  disabled={
                    (!formValidated && loading) || (!captchaVerified && loading)
                  }
                />
                ...
                <div className="btn-iniciarsesion-registro">
                  ...
                  <NavLink to="/login">
                    <p className="inicia-ahora-registro">
                      ¡Inicia sesión ahora!
                    </p>
                  </NavLink>
                </div>
